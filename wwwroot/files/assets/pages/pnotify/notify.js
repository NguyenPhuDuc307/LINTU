...
$(function () {
  ...
  $("#pnotify-custom-styled").on("click", function () {
    new PNotify({
      ...
      text: "Check me out! I'm a notice.",
      addclass:
        "alert alert-styled-left alert-styled-custom alert-arrow-left alpha-teal text-teal-800",
    });
  });
  ...
  $("#pnotify-desktop-danger").on("click", function () {
    ...
    new PNotify({
      ...
      .click(function (e) {
        if (
          $(
            ".ui-pnotify-closer, .ui-pnotify-sticker, .ui-pnotify-closer *, .ui-pnotify-sticker *"
          ).is(e.target)
        )
          return;
